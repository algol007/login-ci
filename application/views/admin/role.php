                ...
                <tbody>
                    ...
                    <?php foreach ($role as $role) : ?>
                        <tr>
                            ...
                            <td><?= $role['role'] ?></td>
                            <td>
                                <a href="<?= base_url('admin/access/') . $role['id'] ?>" class="badge badge-success">Access</a>
                                <a href="#editRole" class="open-editRole badge badge-warning" data-toggle="modal" data-id="<?= $role['id'] ?>" data-menu="<?= $role['role'] ?>">Edit</a>
                                <a href="<?= base_url() ?>role/delete/<?= $role['id'] ?>" class="badge badge-danger">Delete</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
